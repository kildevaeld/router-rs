...
pub struct Builder<B, C> {
    tree: routing::router::Router<BoxHandler<'static, B, C>>,
    middlewares: Vec<BoxMiddleware<B, C, BoxHandler<'static, B, C>>>,
...
impl<B: HSend + 'static, C: HSendSync + 'static> Routing<B, C> for Builder<B, C> {
    type Handler = BoxHandler<'static, B, C>;
...
impl<B: HSend, C: HSendSync> Router<B, C> {
    ...
    pub fn into_parts(
        ...
        routing::router::Router<BoxHandler<'static, B, C>>,
        ModifierList<B, C>,
    ) {
...
pub fn compose<B, C>(
    ...
    task: BoxHandler<'static, B, C>,
) -> BoxHandler<'static, B, C> {

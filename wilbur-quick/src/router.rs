...
impl<'js> IntoJs<'js> for JsRouteContext<'js> {
...
pub enum JsHandler<'js> {
    Script(Function<'js>),
    Handler(BoxHandler<'js, reggie::Body, JsRouteContext<'js>>),
...
impl<'js> Handler<reggie::Body, JsRouteContext<'js>> for JsHandler<'js> {
...
pub enum JsMiddleware<'js> {
    Script(Function<'js>),
    Middleware(BoxMiddleware<reggie::Body, JsRouteContext<'js>, JsHandler<'js>>),
}
...
impl<'js> Middleware<reggie::Body, JsRouteContext<'js>, JsHandler<'js>> for JsMiddleware<'js> {
...
pub struct Router<'js> {
    ...
    modifiers: Vec<BoxModifier<reggie::Body, JsRouteContext<'js>>>,
}
...
impl<'js> Routing<reggie::Body, JsRouteContext<'js>> for Router<'js> {
    type Handler = JsHandler<'js>;

    fn modifier<M: Modifier<reggie::Body, JsRouteContext<'js>> + 'static>(&mut self, modifier: M) {
    ...
    where
        T: Handler<reggie::Body, JsRouteContext<'js>> + 'static,
    {
        self.tree
    ...
    where
        M: Middleware<reggie::Body, JsRouteContext<'js>, Self::Handler> + 'static,
    {
        todo!("Middlewares")
    }
}
...
pub struct ResolvedRouter<'js> {
    ...
    modifiers: ModifierList<reggie::Body, JsRouteContext<'js>>,
    debug: bool,
}

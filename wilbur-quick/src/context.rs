...
impl<'js> BuildContext for JsBuildContext<'js> {
    type Context = JsRouteContext<'js>;
...
impl<'js> Routing<reggie::Body, JsRouteContext<'js>> for JsBuildContext<'js> {
    type Handler = JsHandler<'js>;

    fn modifier<M: wilbur_core::Modifier<reggie::Body, JsRouteContext<'js>> + 'static>(
        &mut self,
        modifier: M,
    ) {
    ...
    where
        T: wilbur_core::Handler<reggie::Body, JsRouteContext<'js>> + 'static,
    {
    ...
    where
        M: wilbur_core::Middleware<reggie::Body, JsRouteContext<'js>, Self::Handler> + 'static,
    {
...
pub struct JsRouteContext<'js> {
    extensions: Hrc<Extensions>,
    b: PhantomData<&'js ()>,
}

impl<'js> Extensible for JsRouteContext<'js> {
    fn extensions(&self) -> &Extensions {
        &self.extensions
    }
}

impl<'js> Trace<'js> for JsRouteContext<'js> {
